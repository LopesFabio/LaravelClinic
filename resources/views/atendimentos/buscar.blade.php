    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Buscar Consulta</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="login-box">
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg">Buscar Consulta por:</p>
                    <!-- Consulta_ID -->
                    <div class="input-group mb-3">
                        <form action="{{route('busca.codigo')}}" method="POST">
                            {{csrf_field()}}
                    ...
                    <!-- Paciente -->
                    <div class="input-group mb-3">
                        <form action="{{route('busca.paciente')}}" method="POST">
                            {{csrf_field()}}
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                <li class="nav-item has-treeview">
                                    <a href="#" class="nav-link">
                    ...
                    <!-- Mês -->
                    <div class="input-group mb-3">
                        <form action="{{route('busca.mes')}}" method="POST">
                            {{csrf_field()}}
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                <li class="nav-item has-treeview">
                                    <a href="#" class="nav-link">
                    ...
                    <!-- Dia -->
                    <div class="input-group mb-3">
                        <form action="{{route('busca.dia')}}" method="POST">
                            {{csrf_field()}}
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                <li class="nav-item has-treeview">
                                    <a href="#" class="nav-link">
